    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-md animate-fade-in">
      <div className="w-full max-w-md bg-card border border-border/80 rounded-3xl p-6 shadow-2xl space-y-5 animate-scale-in">
        ...
        <button
          ...
          className="w-full h-11 rounded-2xl border border-border/80 bg-card hover:bg-muted/70 active:bg-muted text-foreground font-bold text-xs flex items-center justify-center gap-3 transition-all cursor-pointer shadow-sm hover:shadow active:scale-[0.99]"
        >
