...
import { BarChart3, TrendingUp, Users, CheckCircle2, ArrowUpRight, Server, GitBranch, FolderKanban } from 'lucide-react'
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {metricCards.map((m, i) => (
          <div key={i} className="p-5 rounded-3xl bg-card border border-border/80 shadow-sm flex flex-col justify-between">
      ...
      {/* Velocity and Sprint Distribution */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Environment Stage Distribution */}
